  ...
  return (
    <div className="mx-auto max-w-md">
      ...
      <form onSubmit={submit} className="mt-6 rounded-2xl border border-zinc-200 bg-white p-5 shadow dark:border-zinc-900 dark:bg-zinc-950">
        <label className="block text-sm text-zinc-700 dark:text-zinc-300">Student ID</label>
        <input
          value={studentId}
        ...
        <label className="mt-4 block text-sm text-zinc-700 dark:text-zinc-300">Password</label>
        <input
          value={password}
